  ...
  return (
    <div className="App">
      ...
      <div className="comments-container">
        ...
        />{" "}
        <button  type="button" className="btn btn-danger" onClick={onAdd}>Add</button>
      </div>
      <div
        style={{
    ...
    <div className="Comment">
      ...
      >
        ...
        {childCommments.length > 0 && (
          <button type="button" className="btn btn-secondary" onClick={() => setShow((show) => !show)}>
            {show ? "Hide" : "Show"}
          </button>
        )}
      </div>
          ...
          {showAddComponet ? (
            <>
              <input
                ...
                placeholder="add comment"
              />{" "}
              <button type="button" className="btn btn-light m-2" onClick={onAdd}>Submit</button>
            </>
          ) : (
            <a
